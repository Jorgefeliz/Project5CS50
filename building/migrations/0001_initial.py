    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(default='resident', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='building.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Announcement',
            fields=[
                ...
                ('type_of_event', models.CharField(max_length=64)),
                ('status', models.CharField(max_length=64)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='announce', to='building.profile')),
            ],
        ),
    ]
